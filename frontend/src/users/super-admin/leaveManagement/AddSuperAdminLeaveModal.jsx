// src/components/leaveManagement/AddSuperAdminLeaveModal.jsx

import React, { useState, useEffect } from 'react';
import Swal from 'sweetalert2';
import { createLeaveBySuperAdmin } from '../../../api/super-admin/superAdminLeaveApi';
import { fetchBranchAdmins } from '../../../api/super-admin/superAdminUser';

const AddSuperAdminLeaveModal = ({ showModal, setShowModal, reloadLeaves }) => {
    ...
    useEffect(() => {
        fetchBranchAdminsData();
    }, []);

    const fetchBranchAdminsData = async () => {
        try {
            const branchAdminsArray = await fetchBranchAdmins();
            setBranchAdmins(branchAdminsArray.data);
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!formData.branchAdminId) {
                Swal.fire('Error!', 'Please select a Branch Admin.', 'error');
                return;
            }
            ...
            await createLeaveBySuperAdmin(formData);
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-gray-700 font-semibold">Select Branch Admin</label>
                        <select
                            name="branchAdminId"
...
export default AddSuperAdminLeaveModal;
